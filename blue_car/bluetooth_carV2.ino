...
#define Led_Front_Light 25   // D16 - Ön Far (Beyaz) - A1 yerine GPIO16
#define Led_Foggy_Light 26     // D17 - Sis Farı - A2 yerine GPIO17

// LDR Pin
#define Ldr A0                // A0 - Analog pin (GPIO36)
...
const int ldrThreshold = 125; // Bu değeri ortam ışığına göre ayarlayın
...
void allLedsOff() {
  ...
  // Sis farı LDR kontrolünde olduğu için burada kapatılmıyor
}
